...
import java.sql.*;
/**
* Controller class responsible for managing interactions between the system and the
* database.
...
public class DataBaseController implements DBCredentials{
  ...
  /**
	 * finds a ticket in the database using the ticketID and returns   the ticket object
  ...
  /**
	 * removes a ticket with the given ticket id from the Ticket table * in the database
	 * @param ticketID is a ticket id
	 */
  ...
  /**
	 * verifies the login information entered by the user and returns a registeredUser object
    ...
    try{
      ...
      while(rs.next()){
        ...
        if(username.equals(rs.getString(1)) && password.equals(rs.getString(2))){
          ru = new RegisteredUser(null,null,null,null,rs.getString(3),rs.getString(5),rs.getString(6),rs.getFloat(4),rs.getString(7),rs.getString(8),rs.getString(10));
          break;
        }
      }
    }catch(SQLException e) {
  ...
  /**
	 * Reads in all the Seats from the Seat table in the database and returns them in an ArrayList
   * @return 
	 */
  ...
  /**
	 * Reads in all the Showtimes from the Showtime table in the database and returns them in an ArrayList
   * @return 
	 */
  ...
  /**
	 * Reads in all the Movies from the Movie table in the database and returns them in an ArrayList
   * @return 
	 */
  ...
  /**
	 * finds a credit in the database using the id and returns the value of the credit
  ...
  /**
	 * removes a credit with the given credit id from the Credit table * in the database
  ...
  /**
	 * updates the value of the credit with the given id in the Credit table in the database
