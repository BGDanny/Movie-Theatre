...
public class Date{
  ...
  /**
  * Constructor that takes four integers representing a month, day, hour, and minute,
  * and sets them to the relevant variables.
  ...
  */
   ...
   * @return boolean representing if the incoming date object has the same values as this one
	 */
