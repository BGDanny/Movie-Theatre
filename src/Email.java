...
public abstract class Email{
  ...
  /**
  * Constructor that takes in the email address of the recipiant and the ID of the
  * ticket being bought or cancelled, and sets them to the relevant variables.
  */
