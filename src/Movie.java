...
/**
 * Class represeting a movie that is being played at a theatre. It contains
 * variables holding information about the movie's different showtimes, and if
 * regular users of the system are able to book tickets for it yet.
 * 
...
public class Movie {
  ...
  /**
   * Constructor that takes in the name of the movie and whether it has been
   * released to the public, assigns the relavent variables. Also sets an empty
   * arraylist to showtimes.
   */
  ...
  /**
   * Checks that each showtime in variable showtimes for at least one available
   * seat, in which case it will add that showtime to an ArrayList of showtimes
