...
public class PaymentController {
  ...
  */
  ...
  /**
	 * returns true if the payment info entered is formatted right, returns false otherwise
	 * @return boolean indicating if the payment information was verified successfully.
	 */
