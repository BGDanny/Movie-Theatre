...
/**
 * Class representing a showtime of a specific movie at a theatre. It contains
 * variables listing the seats in that showtime, seats that are only available
 * to be preordered, and information about when the showtime is.
 * 
...
public class Showtime {
  ...
  /**
   * Constructor that takes in the date of the showtime and the name of the
   * corrosponding movie.
   * 
  ...
  public String toString() {
    ...
    String message = "Month: " + month + " Day: " + time.getDay() + " Hour: " + time.getHour() + " Minute: "
        + time.getMinute();
    return message;
  }
