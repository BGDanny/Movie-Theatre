...
/**
 * Class representing a Theatre. It has variables storing all of the movies that
 * are shown at the theatre, and the name of the theatre.
 * 
...
public class Theatre {
  ...
  /**
   * converts the ArrayList of Movies into a String array and returns it
   * 
   * @return String array holding the names of all available movies.
   */
