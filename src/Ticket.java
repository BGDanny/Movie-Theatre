/**
 * Class representing a ticket for a specific seat, showtime and movie at a
 * theatre. It has variables to hold this information, and a unique ticket id
 * number.
 * 
...
public class Ticket {
   ...
   * 
   * @param id        int holding the ID number of the ticket to be assigned to
   *                  ticketNumber.
   * @param movieName String holding the name of the movie to be assigned to
   *                  theMovie.
   ...
   */
  public Ticket(int id, String movieName, int month, int day, int hour, int minute, int row, int column,
      String seatType, double cost) {
    setTicketNumber(id);
   ...
   */
  public Ticket(int id, String movieName, int month, int day, int hour, int minute, int row, int column,
      String seatType, double cost, int ID) {
    setTicketNumber(id);
    setTheMovie(movieName);
    setTheShowtime(new Showtime(month, day, hour, minute));
   ...
   * 
   * @param t  Theatre object representing the theatre of the showtime the ticket
   *           is for.
   ...
   * @param s  Seat object representing the specific seat the ticket entitiles the
   *           user to.
   */
