/**
 * Class representing a basic user. It contains variables allowing communication
 * with the controllers. Its methods allow for a customer to pay for tickets, as
 * well as become a registered user.
 * 
...
public class User {
   ...
   * 
   * @param tc                TheatreController object that will be assigned to
   *                          theatreControl.
   * @param dbc               DataBaseController object that will be assigned to
   *                          DBControl.
   * @param tktc              TicketController object that will be assigned to
   *                          ticketControl.
  ...
  /**
   * If the customer has entered valid payment information, makes a payment using
   * the ticket controller and returns true. If the user has entered invalid
  ...
  /**
   * Takes registration information about a customer so that they can become a
   * registered user. It then creates a new RegisteredUser object and sets theUser
   * member variables of ticketControl and theGui to the new object.
   * 
   * @param names      String holding the name of the customer registering as a
   *                   registered user
   * @param add        String holding the address of the customer registering as a
   *                   registered user
   * @param email      String holding the email of a customer registering as a
   *                   registered user
   * @param phone      String holding the phone number of a customer registering
   ...
   * @param expiryDate String holding the expiry date of the registered users
   *                   credit or debit card.
   */
  public void register(String name, String add, String email, String phone, String cardType, String cardNumber,
      String expiryDate) {
  ...
  /**
   * Changes the type of User object that the controllers can see when the
   * customer enterers a valid Registered User loggin. Then gives the registered
   * user access to all of the controllers this user object has.
   * 
